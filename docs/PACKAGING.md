...
sudo eselect repository add mx4 git https://github.com/UsiDiamond/mx-master-4-desktop.git
...
#   set source=("$pkgname::git+https://github.com/UsiDiamond/mx-master-4-desktop.git"), add pkgver()), then:
makepkg -fi
```
